      ...
      child: Material(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isOutlined ? Colors.white : TColor.buttonprimary,
            border: Border.all(color: TColor.buttonprimary, width: 2.5),
            borderRadius: BorderRadius.circular(30),
          ),
          child: Center(
            child: Text(
              ...
              style: TextStyle(
                ...
                fontSize: 20,
                color: isOutlined ? TColor.textprimary : Colors.white,
              ),
            ),
          ),
        ),
